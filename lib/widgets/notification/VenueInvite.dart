...
class _VenueInviteState extends State<VenueInvite> {
  ...
  RichText getBodyText(ThemeData theme) {
    return RichText(
      ...
      text: TextSpan(children: [
        ...
        TextSpan(
            text: 'lit a venue beacon: ', style: theme.textTheme.bodyMedium),
        TextSpan(
  ...
  List<Widget> getTypeButtons() {
    ...
    if (!currentUser.beaconsAttending!
        .contains(widget.notification!.beaconId)) {
      return [
        Padding(
            ...
            onPressed: () {
              setState(() {
                _beaconService!.changeGoingToCasualBeacon(
                    currentUser,
                    widget.notification!.beaconId,
                    widget.notification!.beaconTitle,
                    widget.sender!);
              });
            },
          ),
