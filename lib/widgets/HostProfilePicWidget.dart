...
class HostProfilePicture extends StatelessWidget {
  ...
  String url = '';
  static CacheManager customCacheManager = CacheManager(Config('customCacheKey',
      stalePeriod: Duration(days: 2), maxNrOfCacheObjects: 120));
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(onTap: onClicked ?? null, child: getImage());
  }
